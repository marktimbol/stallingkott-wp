...
function vc_iconpicker_type_simplelineicons( $icons ) {
	$simplelineicons_icons = array(
		array( "icon-user-unfollow" => __( "Unfollow", "core-extension" ) ),
		array( "icon-users" => __( "Users", "core-extension" ) ),
		array( "icon-user-following" => __( "Following", "core-extension" ) ),
		array( "icon-user-follow" => __( "Follow", "core-extension" ) ),
		array( "icon-trophy" => __( "Trophy", "core-extension" ) ),
		array( "icon-speedometer" => __( "Speedometer", "core-extension" ) ),
		array( "icon-social-youtube" => __( "Youtube", "core-extension" ) ),
		array( "icon-social-twitter" => __( "Twitter", "core-extension" ) ),
		array( "icon-social-tumblr" => __( "Tumblr", "core-extension" ) ),
		array( "icon-social-facebook" => __( "Facebook", "core-extension" ) ),
		array( "icon-social-dropbox" => __( "Dropbox", "core-extension" ) ),
		array( "icon-social-dribbble" => __( "Dribbble", "core-extension" ) ),
		array( "icon-shield" => __( "Shield", "core-extension" ) ),
		array( "icon-screen-tablet" => __( "Tablet", "core-extension" ) ),
		array( "icon-screen-smartphone" => __( "Smartphone", "core-extension" ) ),
		array( "icon-screen-desktop" => __( "Desktop", "core-extension" ) ),
		array( "icon-plane" => __( "Plane", "core-extension" ) ),
		array( "icon-notebook" => __( "Notebook", "core-extension" ) ),
		array( "icon-moustache" => __( "Moustache", "core-extension" ) ),
		array( "icon-mouse" => __( "Mouse", "core-extension" ) ),
		array( "icon-magnet" => __( "Magnet", "core-extension" ) ),
		array( "icon-magic-wand" => __( "Magic Wand", "core-extension" ) ),
		array( "icon-hourglass" => __( "Hourglass", "core-extension" ) ),
		array( "icon-graduation" => __( "Graduation", "core-extension" ) ),
		array( "icon-ghost" => __( "Ghost", "core-extension" ) ),
		array( "icon-game-controller" => __( "Game Controller", "core-extension" ) ),
		array( "icon-fire" => __( "Fire", "core-extension" ) ),
		array( "icon-eyeglasses" => __( "Eyeglasses", "core-extension" ) ),
		array( "icon-envelope-open" => __( "Envelope Open", "core-extension" ) ),
		array( "icon-envelope-letter" => __( "Letter", "core-extension" ) ),
		array( "icon-energy" => __( "Energy", "core-extension" ) ),
		array( "icon-emoticon-smile" => __( "Smile", "core-extension" ) ),
		array( "icon-disc" => __( "Disc", "core-extension" ) ),
		array( "icon-cursor-move" => __( "Cursor Move", "core-extension" ) ),
		array( "icon-crop" => __( "Crop", "core-extension" ) ),
		array( "icon-credit-card" => __( "Credit Card", "core-extension" ) ),
		array( "icon-chemistry" => __( "Chemistry", "core-extension" ) ),
		array( "icon-bell" => __( "Bell", "core-extension" ) ),
		array( "icon-badge" => __( "Badge", "core-extension" ) ),
		array( "icon-anchor" => __( "Anchor", "core-extension" ) ),
		array( "icon-action-redo" => __( "Redo", "core-extension" ) ),
		array( "icon-action-undo" => __( "Undo", "core-extension" ) ),
		array( "icon-bag" => __( "Bag", "core-extension" ) ),
		array( "icon-basket" => __( "Basket", "core-extension" ) ),
		array( "icon-basket-loaded" => __( "Basket Loaded", "core-extension" ) ),
		array( "icon-book-open" => __( "Book", "core-extension" ) ),
		array( "icon-briefcase" => __( "Briefcase", "core-extension" ) ),
		array( "icon-bubbles" => __( "Bubbles", "core-extension" ) ),
		array( "icon-calculator" => __( "Calculator", "core-extension" ) ),
		array( "icon-call-end" => __( "Call End", "core-extension" ) ),
		array( "icon-call-in" => __( "Call In", "core-extension" ) ),
		array( "icon-call-out" => __( "Call Out", "core-extension" ) ),
		array( "icon-compass" => __( "Compass", "core-extension" ) ),
		array( "icon-cup" => __( "Cup", "core-extension" ) ),
		array( "icon-diamond" => __( "Diamond", "core-extension" ) ),
		array( "icon-direction" => __( "Direction", "core-extension" ) ),
		array( "icon-directions" => __( "Directions", "core-extension" ) ),
		array( "icon-docs" => __( "Docs", "core-extension" ) ),
		array( "icon-drawer" => __( "Drawer", "core-extension" ) ),
		array( "icon-drop" => __( "Drop", "core-extension" ) ),
		array( "icon-earphones" => __( "Earphones", "core-extension" ) ),
		array( "icon-earphones-alt" => __( "Earphones Alt", "core-extension" ) ),
		array( "icon-feed" => __( "Feed", "core-extension" ) ),
		array( "icon-film" => __( "Film", "core-extension" ) ),
		array( "icon-folder-alt" => __( "Folder Alt", "core-extension" ) ),
		array( "icon-frame" => __( "Frame", "core-extension" ) ),
		array( "icon-globe" => __( "Globe", "core-extension" ) ),
		array( "icon-globe-alt" => __( "Globe Alt", "core-extension" ) ),
		array( "icon-handbag" => __( "Handbag", "core-extension" ) ),
		array( "icon-layers" => __( "Layers", "core-extension" ) ),
		array( "icon-map" => __( "Map", "core-extension" ) ),
		array( "icon-picture" => __( "Picture", "core-extension" ) ),
		array( "icon-pin" => __( "Pin", "core-extension" ) ),
		array( "icon-playlist" => __( "Playlist", "core-extension" ) ),
		array( "icon-present" => __( "Present", "core-extension" ) ),
		array( "icon-printer" => __( "Printer", "core-extension" ) ),
		array( "icon-puzzle" => __( "Puzzle", "core-extension" ) ),
		array( "icon-speech" => __( "Speech", "core-extension" ) ),
		array( "icon-vector" => __( "Vector", "core-extension" ) ),
		array( "icon-wallet" => __( "Wallet", "core-extension" ) ),
		array( "icon-arrow-down" => __( "Arrow Down", "core-extension" ) ),
		array( "icon-arrow-left" => __( "Arrow Left", "core-extension" ) ),
		array( "icon-arrow-right" => __( "Arrow Right", "core-extension" ) ),
		array( "icon-arrow-up" => __( "Arrow Up", "core-extension" ) ),
		array( "icon-bar-chart" => __( "Bar Chart", "core-extension" ) ),
		array( "icon-bulb" => __( "Bulb", "core-extension" ) ),
		array( "icon-calendar" => __( "Calendar", "core-extension" ) ),
		array( "icon-control-end" => __( "End", "core-extension" ) ),
		array( "icon-control-forward" => __( "Forward", "core-extension" ) ),
		array( "icon-control-pause" => __( "Pause", "core-extension" ) ),
		array( "icon-control-play" => __( "Play", "core-extension" ) ),
		array( "icon-control-rewind" => __( "Rewind", "core-extension" ) ),
		array( "icon-control-start" => __( "Start", "core-extension" ) ),
		array( "icon-cursor" => __( "Cursor", "core-extension" ) ),
		array( "icon-dislike" => __( "Dislike", "core-extension" ) ),
		array( "icon-equalizer" => __( "Equalizer", "core-extension" ) ),
		array( "icon-graph" => __( "Graph", "core-extension" ) ),
		array( "icon-grid" => __( "Grid", "core-extension" ) ),
		array( "icon-home" => __( "Home", "core-extension" ) ),
		array( "icon-like" => __( "Like", "core-extension" ) ),
		array( "icon-list" => __( "List", "core-extension" ) ),
		array( "icon-login" => __( "Login", "core-extension" ) ),
		array( "icon-logout" => __( "Logout", "core-extension" ) ),
		array( "icon-loop" => __( "Loop", "core-extension" ) ),
		array( "icon-microphone" => __( "Microphone", "core-extension" ) ),
		array( "icon-music-tone" => __( "Tone", "core-extension" ) ),
		array( "icon-music-tone-alt" => __( "Tone Alt", "core-extension" ) ),
		array( "icon-note" => __( "Note", "core-extension" ) ),
		array( "icon-pencil" => __( "Pencil", "core-extension" ) ),
		array( "icon-pie-chart" => __( "Chart", "core-extension" ) ),
		array( "icon-question" => __( "Question", "core-extension" ) ),
		array( "icon-rocket" => __( "Rocket", "core-extension" ) ),
		array( "icon-share" => __( "Share", "core-extension" ) ),
		array( "icon-share-alt" => __( "Share Alt", "core-extension" ) ),
		array( "icon-shuffle" => __( "Shuffle", "core-extension" ) ),
		array( "icon-size-actual" => __( "Size Actual", "core-extension" ) ),
		array( "icon-size-fullscreen" => __( "Size Fullscreen", "core-extension" ) ),
		array( "icon-support" => __( "Support", "core-extension" ) ),
		array( "icon-tag" => __( "Tag", "core-extension" ) ),
		array( "icon-trash" => __( "Trash", "core-extension" ) ),
		array( "icon-umbrella" => __( "Umbrella", "core-extension" ) ),
		array( "icon-wrench" => __( "Wrench", "core-extension" ) ),
		array( "icon-ban" => __( "Ban", "core-extension" ) ),
		array( "icon-bubble" => __( "Bubble", "core-extension" ) ),
		array( "icon-camcorder" => __( "Camcorder", "core-extension" ) ),
		array( "icon-camera" => __( "Camera", "core-extension" ) ),
		array( "icon-check" => __( "Check", "core-extension" ) ),
		array( "icon-clock" => __( "Clock", "core-extension" ) ),
		array( "icon-close" => __( "Close", "core-extension" ) ),
		array( "icon-cloud-download" => __( "Cloud Download", "core-extension" ) ),
		array( "icon-cloud-upload" => __( "Cloud Upload", "core-extension" ) ),
		array( "icon-doc" => __( "Doc", "core-extension" ) ),
		array( "icon-envelope" => __( "Envelope", "core-extension" ) ),
		array( "icon-eye" => __( "Eye", "core-extension" ) ),
		array( "icon-flag" => __( "Flag", "core-extension" ) ),
		array( "icon-folder" => __( "Folder", "core-extension" ) ),
		array( "icon-heart" => __( "Heart", "core-extension" ) ),
		array( "icon-info" => __( "Info", "core-extension" ) ),
		array( "icon-key" => __( "Key", "core-extension" ) ),
		array( "icon-link" => __( "Link", "core-extension" ) ),
		array( "icon-lock" => __( "Lock", "core-extension" ) ),
		array( "icon-lock-open" => __( "Lock Open", "core-extension" ) ),
		array( "icon-magnifier" => __( "Magnifier", "core-extension" ) ),
		array( "icon-magnifier-add" => __( "Magnifier Add", "core-extension" ) ),
		array( "icon-magnifier-remove" => __( "Magnifier Remove", "core-extension" ) ),
		array( "icon-paper-clip" => __( "Paper Clip", "core-extension" ) ),
		array( "icon-paper-plane" => __( "Paper Plane", "core-extension" ) ),
		array( "icon-plus" => __( "Plus", "core-extension" ) ),
		array( "icon-pointer" => __( "Pointer", "core-extension" ) ),
		array( "icon-power" => __( "Power", "core-extension" ) ),
		array( "icon-refresh" => __( "Refresh", "core-extension" ) ),
		array( "icon-reload" => __( "Reload", "core-extension" ) ),
		array( "icon-settings" => __( "Settings", "core-extension" ) ),
		array( "icon-star" => __( "Star", "core-extension" ) ),
		array( "icon-symbol-female" => __( "Female", "core-extension" ) ),
		array( "icon-symbol-male" => __( "Male", "core-extension" ) ),
		array( "icon-target" => __( "Target", "core-extension" ) ),
		array( "icon-user-female" => __( "Female", "core-extension" ) ),
		array( "icon-user" => __( "User", "core-extension" ) ),
		array( "icon-volume-1" => __( "Volume 1", "core-extension" ) ),
		array( "icon-volume-2" => __( "Volume 2", "core-extension" ) ),
		array( "icon-volume-off" => __( "Volume Off", "core-extension" ) ),
	);
