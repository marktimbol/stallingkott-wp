...
jQuery(document).ready(function(){
	"use strict";
	var options = {};
	jQuery('.vc_pie_wrapper').each(function() {

		$(this).waypoint(function() {
			var $this       = $(this),
				value       = $this.data('pie-value') / 100,
				label_value = $this.data('pie-label-value'),
				units       = $this.data('pie-units'),
				color       = $this.data('pie-color'),
				width       = $this.data('pie-width'),
				text_color  = $this.data('pie-text-color'),
				track_color = $this.data('pie-track-color'),
				bg_color    = $this.data('pie-bg-color'),
				duration    = $this.data('pie-duration'),
				easing      = $this.data('pie-easing');

				track_color = (track_color == '' ? 'transparent' : track_color);
			...
			options = {
				...
				step: function (state, bar) {
					bar.setText((bar.value() * 100).toFixed(0) + units);
				}
			}

			var circle = new ProgressBar.Circle(this, options);
