...
if ( ! function_exists( 'ot_admin_styles' ) ) {
  ...
  function ot_admin_styles() {
	...
	wp_register_style( 'font-awesome', OT_URL . 'assets/css/font-awesome.css', false, '', 'all' );
...
if ( ! function_exists( 'ot_theme_options_support' ) ) {
	function ot_theme_options_support() {
		echo '	<div class="custom_links">
					<a class="custom_link" href="http://whitecollars.co/documentation/tilt/" target="_blank">User manual</a>
					<a class="custom_link" href="https://whitecollars.ticksy.com/" target="_blank">Support forum</a>
				</div>';
	}
}
